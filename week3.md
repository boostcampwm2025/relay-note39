...
**1️⃣ 면접을 위한 CS 지식 공유하고 설문받기**
- 몰랐던 것/유용했던 것 랭킹 매기기
- 커뮤니티를 통한 집단 지성 활용

**2️⃣ 학습 키워드로부터 퀴즈 생성해서 슬랙에 공유하기**
- 헷갈리게 만드는 문제로 깊은 학습 유도
- 이모지로 답변받기 (O, X 또는 숫자 이모지)
- 다음날 문제와 함께 이전 정답도 공유
- 매일매일 가볍게 참여할 수 있는 활동

**3️⃣ 언어별 API/문법 차이를 보여주는 4컷 만화 생성하기**
- 이미지 생성 및 공유 경험
- 공부한 내용을 시각적으로 표현
- 예시: 콘솔 출력 방법
...
**4️⃣ 학습정리.md 기반 NotebookLM 퀴즈로 피어피드백 순서 정하기**
- 미루지 않게 되는 미션 설계
- ZOOM에서 퀴즈 진행
- 맞추면 피어피드백 발표 순서 선정 기회 부여
- 목표: 학습저장소를 잘 읽었는지 확인

**💡 추가 자료**
- 퀘스트 시 참고할만한 프롬프팅 링크 제공
